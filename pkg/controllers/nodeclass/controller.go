...
type Controller struct {
	...
	reconcilers []reconcile.TypedReconciler[*v1alpha1.YandexNodeClass]
}
...
//nolint:gocyclo
func (c *Controller) Reconcile(ctx context.Context, nodeClass *v1alpha1.YandexNodeClass) (reconcile.Result, error) {
